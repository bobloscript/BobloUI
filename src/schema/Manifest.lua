-- generated full manifest; edit build/manifest.json instead.
return {
	...
	["Components"] = {
		...
		["Dropdown"] = {
			["method"] = "AddDropdown",
			["summary"] = "Single or multi-select dropdown.",
			["stateful"] = true,
			["required"] = { "Title" },
			["options"] = {
				["Options"] = "table?",
		...
		["Keybind"] = {
			["method"] = "AddKeybind",
			["summary"] = "Chord-capable keyboard/mobile binding with custom modes.",
			["stateful"] = true,
			["options"] = {
				["Default"] = "any?",
				["Mode"] = "string?",
		...
		["ColorPicker"] = {
			...
			["summary"] = "Color selector with HEX/RGB entry.",
			["stateful"] = true,
			["options"] = {
				["Default"] = "Color3?",
				["Alpha"] = "boolean?",
		...
		["Paragraph"] = {
			["method"] = "AddParagraph",
			["summary"] = "Rich explanatory text; omit Title for label-like text.",
			["stateful"] = false,
			["options"] = {
				["Content"] = "string?",
				["Variant"] = "string?",
		...
		["Divider"] = {
			["method"] = "AddDivider",
			["summary"] = "Visual separator with optional title.",
			["stateful"] = false,
			["options"] = {
				["Text"] = "string?",
				["Margin"] = "number?",
			...
			["methods"] = { ["SetMargins"] = "Set the top and bottom whitespace around the divider." },
			["required"] = {},
		},
		["Status"] = {
			["method"] = "AddStatus",
			["summary"] = "Read-only live status indicator; may read State by Id but is never persisted.",
			["stateful"] = true,
			["options"] = { ["Value"] = "any?", ["Status"] = "string?", ["Pulse"] = "boolean?" },
			["methods"] = { ["SetStatus"] = "Change Neutral/Success/Warning/Error/Info/Pending state." },
			["required"] = { "Title" },
		},
		["Progress"] = {
			["method"] = "AddProgress",
			["summary"] = "Determinate or indeterminate progress bar.",
			["stateful"] = true,
			["required"] = { "Title" },
			["options"] = {
				["Min"] = "number?",
			...
			["methods"] = { ["SetIndeterminate"] = "Enable or disable indeterminate animation." },
		},
		["Code"] = {
			["method"] = "AddCode",
			["summary"] = "Read-only code block with optional copy action.",
			["stateful"] = false,
			["required"] = {},
			["options"] = {
				["Code"] = "string?",
		...
		["Image"] = {
			["method"] = "AddImage",
			["summary"] = "Image/media block using Roblox asset content.",
			["stateful"] = false,
			["required"] = { "Image" },
			["options"] = {
				["Image"] = "string",
		...
		["Passthrough"] = {
			...
			["summary"] = "Host an existing Roblox GuiObject.",
			["stateful"] = false,
			["required"] = { "Instance" },
			["options"] = {
				["Instance"] = "Instance",
		...
		["Viewport"] = {
			["method"] = "AddViewport",
			["summary"] = "Interactive 3D ViewportFrame control.",
			["stateful"] = false,
			["required"] = { "Object" },
			["options"] = {
				["Object"] = "Instance",
		...
		["Video"] = {
			["method"] = "AddVideo",
			["summary"] = "VideoFrame control with playback API.",
			["stateful"] = false,
			["required"] = { "Video" },
			["options"] = {
				["Video"] = "string",
